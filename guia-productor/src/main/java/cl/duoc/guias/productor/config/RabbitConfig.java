...
public class RabbitConfig {
    ...
    @Bean
    DirectExchange guiaExchange() { return new DirectExchange(EXCHANGE, true, false); }
    ...
    @Bean
    Binding guiaBinding(Queue guiaQueue, DirectExchange guiaExchange) {
        return BindingBuilder.bind(guiaQueue).to(guiaExchange).with(ROUTING_KEY);
    }
